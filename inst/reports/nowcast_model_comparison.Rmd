...
# ds_lag_pd_by_disease <- map(top_vars, function(var){
#   map(oie_high_importance_diseases, function(disease){
#     
...
#           verbose = FALSE
#         )
#         var_resp <- model_profile(explainer_disease_status_sub, variable =  var , type = "partial")
...
#       
#       var_resp <- model_profile(explainer_disease_status_sub2, variable =  var , type = "partial")
#       plot(var_resp, geom = "profiles") + # ceteris-paribus (CP) profiles
#         labs(title = chng, subtitle = "")
#   })
# })
# write_rds(ds_lag_pd_by_dirchange, here::here("tmp/ds_lag_pd_by_dirchange"))
ds_lag_pd_by_dirchange <- read_rds(here::here("tmp/ds_lag_pd_by_dirchange"))
...
<!--         verbose = FALSE -->
<!--       ) -->
<!--       var_resp <- model_profile(explainer_cases_sub, variable =  "cases_lag1" , type = "partial") -->
<!--       plot(var_resp, geom = "profiles") + # ceteris-paribus (CP) profiles -->
<!--         labs(title = disease, subtitle = "") -->
<!--     } -->
<!--   } -->

...
# ASF Outbreak Probability in DR over last year
```{r dr-last-yr}
...
ggplot(asf_outbreak_in_dom, aes(x = month, y = `Predicted Outbreak Probability (%)`, group = country_iso3c,
  ...
  geom_line() + 
  scale_color_manual(values = c("other" = "gray50", "United States" = "blue", "Dominican Republic" = "maroon2")) +

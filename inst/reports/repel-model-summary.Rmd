...
network_augment_predict <- get_cached_network_predictions(conn)
#disagg_network_augment_predict <- get_cached_disagg_network_predictions(conn)
disagg_network_augment_predict <- vroom::vroom(here("tmp/disagg_network_predict.csv.gz"))
...
vi_usa <- get_network_variable_importance(network_augment_predict, randef,
                                          country_iso3c = "USA",
...
vi_usa_co <- get_network_variable_importance_with_origins(disagg_network_augment_predict, randef,
                                          country_iso3c = "USA",
                                          diseases = get_oie_high_importance_diseases(),
                                          month = "2018-12-01")
